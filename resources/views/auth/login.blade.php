...
<div class="centered-form">
    <div class="col-lg-5">
        <form role="form" action="{{ route('login') }}" class="get-a-quote" method="post">
            @csrf
            ...
            <div class="login" style="margin-top: 20px">
                ...
                <a class="hover-link" href="{{ route('register_form') }}"> Нет аккаунта? Зарегистрироваться</a>
            </div>
            <div class="back">
                <a class="hover-link" href="{{ route('password.request') }}">Забыли пароль? Восстановить</a>
